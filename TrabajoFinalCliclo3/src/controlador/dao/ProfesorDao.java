       ...
       public ListaEnlazada<Profesores> getProfesores(String atributo, Object o, Boolean m) {
        ...
        try {
            ...
            while (resultado.next()) {
                Profesores profesor = new Profesores(resultado.getString(0), resultado.getString(1), resultado.getString(2), resultado.getString(3), resultado.getString(4), resultado.getString(5).charAt(0), resultado.getString(6), TipoEmpleado.P_PRO, resultado.getString(7));
